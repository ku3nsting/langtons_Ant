...
choice = 0
choice = validate_ints(choice, 4)

color = choice

print "\n Choose a size for your grid (ant will start in the middle):"

size = 0
size = validate_ints(size, 70)
...
if(color == 3):
        ...
        #earth
if(color == 4):
        X = '\x1b[5;30;47m' + 'X' + '\x1b[0m'
        W = '\x1b[0;36;44m' + '-' + '\x1b[0m'
        B = '\x1b[0;32;43m' + '#' + '\x1b[0m'
